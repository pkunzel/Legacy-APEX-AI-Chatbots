...
create or replace type body bot_openai_provider_t as
   ...
   begin
      return bot_adapter_openai.get_text_response(
         p_url              => self.url,
